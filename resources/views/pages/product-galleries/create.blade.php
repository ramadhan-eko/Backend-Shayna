        ...
        <div class="card-body card-block">
            <form action="{{ route('product-galleries.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <br>  
                    <input type="radio" name="is_default" value="1" class="@error('is_default') is-invalid @enderror">
                    <label>Ya</label>
                    <br>  
                    <input type="radio" name="is_default" value="0" class="@error('is_default') is-invalid @enderror">
                    <label>Tidak</label>
                    @error('is_default')
                    <div class="text-muted">{{ $message }}</div>
                    @enderror
